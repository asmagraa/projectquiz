...
public class MainActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        t1_question = (TextView) findViewById(R.id.questionTxt3);
        timerTxt = (TextView) findViewById(R.id.timerTxt3);
    ...
    private void updateQuestion()
    {
        ...
        if(total >7)
        {
            Intent f = new Intent(MainActivity3.this, ResultActivity.class);
        ...
        {
            reference = FirebaseDatabase.getInstance().getReference().child("Questions3").child(String.valueOf(total));
    ...
    public void reverseTimer(int seconds,final TextView tv)
    {
        new CountDownTimer(seconds* 1000+1000, 1000){
            ...
            public void onFinish() {
                tv.setText("Fin");
                Intent myIntent = new Intent(MainActivity3.this, ResultActivity.class);
